                                ...
                                <div class="col-xl-10 col-lg-9 col-md-8 col-sm-12">
                                    <div class="tab-content" id="v-pills-tabContent">
                                        <div class="pt_0 tab-pane fade show active" id="v-1" role="tabpanel"
                                            ...
                                            <!-- Setting Home Page Start -->
                                            <div class="form-group mb-3">
                                                <label>News Ticker Total Item</label>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="news_ticker_status" class="form-control">
                                                    <option value="Show"
                                                        @if ($setting_data->news_ticker_status == 'Show') selected @endif>Show</option>
                                                    <option value="Hide"
                                                        @if ($setting_data->news_ticker_status == 'Hide') selected @endif>Hide</option>
                                                </select>
                                            </div>
                                            <!-- Settin Home Page End -->
                                        </div>
